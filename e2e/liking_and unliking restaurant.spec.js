...
Scenario("showing empty liked restaurants", ({ I }) => {
  I.seeElement("#query");
  I.see("There are no restaurants to feature", ".restaurant-item__not__found");
});
Scenario("liking one restaurant", async ({ I }) => {
  I.see("", ".restaurant-item__not__found");
  I.amOnPage("/");
...
Scenario("unliking one restaurant", async ({ I }) => {
  ...
  I.wait(5);
  I.seeElement(".list-item__content");
  const likedRestaurant = locate(".list-item__content").first();
  ...
  I.amOnPage("/#/favorite");
  I.wait(5);
  I.dontSeeElement(".list-item__content");
});